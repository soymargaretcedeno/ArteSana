            ...
            <style>
                ...
                * {
                ...
                [data-theme="dark"] .footer {
                    background: #2B2118;
                    border-top: 1px solid rgba(242, 200, 114, 0.22);
                }
                ...
                .footer-brand h3:hover .logo-img {
                    filter: drop-shadow(0 4px 10px rgba(255, 215, 0, 0.35));
                }
                            ...
                            <div class="col-lg-3 col-md-6 mb-4">
                                <div class="footer-section">
                                    <div class="footer-brand">
                                        <h3>
                                            <img src="assets/artesana-badge-clear.png" alt="ArteSana" class="logo-img">
                                            <span>ArteSana</span>
                                        </h3>
