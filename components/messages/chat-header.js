            ...
            return `
                <header class="messages-chat-header">
                    ...
                    <div class="messages-chat-actions">
                        <button class="messages-icon-btn" id="msgCallBtn" aria-label="${U.esc(U.t('msg_call', 'Llamada'))}" title="${U.esc(U.t('msg_call', 'Llamada'))}">
                            ${U.icons.phone}
                        </button>
                        <button class="messages-icon-btn" id="msgVideoBtn" aria-label="${U.esc(U.t('msg_video_call', 'Videollamada'))}" title="${U.esc(U.t('msg_video_call', 'Videollamada'))}">
                            ${U.icons.video}
                        </button>
