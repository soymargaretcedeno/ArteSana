...
(function (global) {
    ...
    global.MessagesConversationList = {
        render(activeChatId) {
            const threads = U.sortThreads(
                (global.PlatformServices && global.PlatformServices.getMessageThreads)
                    ? global.PlatformServices.getMessageThreads()
                    : []
            );
